...
import com.mega.browser.mobile.android.database.HistoryEntry
...
import com.mega.browser.mobile.android.html.incognito.IncognitoPageFactory
import com.mega.browser.mobile.android.html.onboarding.OnboardingPageFactory
import com.mega.browser.mobile.android.icon.TabCountView
import com.mega.browser.mobile.android.interpolator.BezierDecelerateInterpolator
import com.mega.browser.mobile.android.log.Logger
import com.mega.browser.mobile.android.notifications.IncognitoNotification
...
import com.mega.browser.mobile.android.browser.BookmarksView
import com.mega.browser.mobile.android.browser.BrowserPresenter
import com.mega.browser.mobile.android.browser.BrowserView
import com.mega.browser.mobile.android.browser.ChooseNavbarCol
import com.mega.browser.mobile.android.browser.PasswordChoice
import com.mega.browser.mobile.android.browser.RecentTabModel
...
import com.mega.browser.mobile.android.di.MainHandler
import com.mega.browser.mobile.android.di.MainScheduler
import com.mega.browser.mobile.android.di.injector
import com.mega.browser.mobile.android.extensions.dimen
import com.mega.browser.mobile.android.extensions.doOnLayout
import com.mega.browser.mobile.android.extensions.drawable
import com.mega.browser.mobile.android.extensions.removeFromParent
...
import com.mega.browser.mobile.android.extensions.tint
...
import com.mega.browser.mobile.android.utils.isDownloadsUrl
import com.mega.browser.mobile.android.utils.isSpecialUrl
import com.mega.browser.mobile.android.utils.smartUrlFilter
import com.mega.browser.mobile.android.view.DownloadPageInitializer
import com.mega.browser.mobile.android.view.HistoryPageInitializer
import com.mega.browser.mobile.android.view.HomePageInitializer
...
abstract class BrowserActivity : ThemableBrowserActivity(), BrowserView, UIController, OnClickListener,
    ...
    @Inject
    lateinit var proxyUtils: com.mega.browser.mobile.android.utils.ProxyUtils
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        prefs = getSharedPreferences("com.mega.browser.mobile.android", MODE_PRIVATE)
...
//        }
        ...
        val primaryColor = com.mega.browser.mobile.android.utils.ThemeUtils.getPrimaryColor(this)
        ...
        if (userPreferences.incognito) {
            ...
            com.mega.browser.mobile.android.utils.WebUtils.clearHistory(this, historyModel, databaseScheduler)
            com.mega.browser.mobile.android.utils.WebUtils.clearCookies(this)
        ...
        if (event.action == KeyEvent.ACTION_DOWN) {
            when {
                event.isCtrlPressed -> when (event.keyCode) {
                    ...
                    KeyEvent.KEYCODE_S -> {
                        com.mega.browser.mobile.android.utils.IntentUtils(this)
                            .shareUrl(tabsManager.currentTab?.url, tabsManager.currentTab?.title)
                        return true
                    }
                    KeyEvent.KEYCODE_R -> {
                        // Refresh current tab
    ...
    protected fun performExitCleanUp() {
        ...
        if (userPreferences.clearCacheExit && currentTab != null && !isIncognito()) {
            com.mega.browser.mobile.android.utils.WebUtils.clearCache(currentTab.webView, applicationContext)
        ...
        if (userPreferences.clearWebStorageExitEnabled && !isIncognito()) {
            com.mega.browser.mobile.android.utils.WebUtils.eraseWebStorage(applicationContext)
            logger.log(TAG, "WebStorage Cleared")
        } else if (isIncognito()) {
            com.mega.browser.mobile.android.utils.WebUtils.clearWebStorage()     // We want to make sure incognito mode is secure
        }
    }
    ...
    override fun changeToolbarColor(tabBackground: Drawable?){
        val primaryColor = com.mega.browser.mobile.android.utils.ThemeUtils.getColorBackground(this)
        ...
        Palette.from(favicon ?: webPageBitmap!!).generate { palette ->
            ...
            val animation = object : Animation() {
                override fun applyTransformation(interpolatedTime: Float, t: Transformation) {
                    val animatedColor = com.mega.browser.mobile.android.utils.DrawableUtils.mixColor(interpolatedTime, currentUiColor, finalColor)
                    if (shouldShowTabsInDrawer) {
                    ...
                    searchBackground?.background?.tint(
                            com.mega.browser.mobile.android.utils.DrawableUtils.mixColor(interpolatedTime, startSearchColor, finalSearchColor)
                    )
                }
            }
    ...
    private fun getSearchBarColor(requestedColor: Int, defaultColor: Int): Int =
            if (requestedColor == defaultColor) {
                if (isDarkTheme) com.mega.browser.mobile.android.utils.DrawableUtils.mixColor(0.25f, defaultColor, Color.WHITE) else Color.WHITE
            } else {
                com.mega.browser.mobile.android.utils.DrawableUtils.mixColor(0.25f, requestedColor, Color.WHITE)
            }
