...
import com.mega.browser.mobile.android.adblock.AdBlocker
...
class SmartCookieWebClient(
    ...
    private val intentUtils = com.mega.browser.mobile.android.utils.IntentUtils(activity)
    ...
    @Inject internal lateinit var proxyUtils: com.mega.browser.mobile.android.utils.ProxyUtils
