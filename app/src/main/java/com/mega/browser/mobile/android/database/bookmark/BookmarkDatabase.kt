package com.mega.browser.mobile.android.database.bookmark
...
import com.mega.browser.mobile.android.database.databaseDelegate
import com.mega.browser.mobile.android.extensions.firstOrNullMap
import com.mega.browser.mobile.android.extensions.useMap
...
class BookmarkDatabase @Inject constructor(
    ...
    private fun Bookmark.Entry.bindBookmarkToContentValues() = ContentValues(4).apply {
        put(com.mega.browser.mobile.android.database.bookmark.BookmarkDatabase.KEY_TITLE, title.takeIf(String::isNotBlank) ?: defaultBookmarkTitle)
        put(com.mega.browser.mobile.android.database.bookmark.BookmarkDatabase.KEY_URL, url)
        put(com.mega.browser.mobile.android.database.bookmark.BookmarkDatabase.KEY_FOLDER, folder.title)
        put(com.mega.browser.mobile.android.database.bookmark.BookmarkDatabase.KEY_POSITION, position)
    }
