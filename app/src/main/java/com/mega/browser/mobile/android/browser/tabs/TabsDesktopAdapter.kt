...
import com.mega.browser.mobile.android.extensions.desaturate
...
class TabsDesktopAdapter(
    ...
    private fun updateViewHolderAppearance(viewHolder: TabViewHolder, favicon: Bitmap?, isForeground: Boolean) {
        if (isForeground) {
            ...
            foregroundDrawable.tint(com.mega.browser.mobile.android.utils.ThemeUtils.getColorBackground(uiController as Context))
            ...
            backgroundDrawable.tint(Utils.mixTwoColors(com.mega.browser.mobile.android.utils.ThemeUtils.getColorBackground(uiController as Context), Color.BLACK, 0.85f))
