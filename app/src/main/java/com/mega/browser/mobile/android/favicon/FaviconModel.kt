package com.mega.browser.mobile.android.favicon

import com.mega.browser.mobile.android.R
import com.mega.browser.mobile.android.extensions.pad
...
class FaviconModel @Inject constructor(
    ...
    private val faviconCache = object : LruCache<String, Bitmap>(com.mega.browser.mobile.android.utils.FileUtils.megabytesToBytes(1).toInt()) {
    ...
    fun createDefaultBitmapForTitle(title: String?): Bitmap {
        ...
        @ColorInt val defaultFaviconColor = com.mega.browser.mobile.android.utils.DrawableUtils.characterToColorHash(firstTitleCharacter, application)

        return com.mega.browser.mobile.android.utils.DrawableUtils.createRoundedLetterImage(
            firstTitleCharacter,
            bookmarkIconSize,
            bookmarkIconSize,
            defaultFaviconColor
