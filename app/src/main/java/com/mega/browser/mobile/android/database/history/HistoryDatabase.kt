 ...
 */
package com.mega.browser.mobile.android.database.history
...
class HistoryDatabase @Inject constructor(
    ...
    private fun HistoryEntry.toContentValues() = ContentValues().apply {
        put(com.mega.browser.mobile.android.database.history.HistoryDatabase.KEY_URL, url)
        put(com.mega.browser.mobile.android.database.history.HistoryDatabase.KEY_TITLE, title)
        put(com.mega.browser.mobile.android.database.history.HistoryDatabase.KEY_TIME_VISITED, lastTimeVisited)
    }
