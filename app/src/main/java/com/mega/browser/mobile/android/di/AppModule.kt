...
import com.mega.browser.mobile.android.html.bookmark.BookmarkPageReader
import com.mega.browser.mobile.android.html.homepage.HomePageReader
import com.mega.browser.mobile.android.log.AndroidLogger
import com.mega.browser.mobile.android.log.Logger
import com.mega.browser.mobile.android.log.NoOpLogger
...
import com.mega.browser.mobile.android.html.incognito.IncognitoPageReader
import com.mega.browser.mobile.android.html.onboarding.OnboardingPageReader
import com.mega.browser.mobile.android.js.*
import com.mega.browser.mobile.android.js.BlockAMP
import com.mega.browser.mobile.android.js.BlockAds
import com.mega.browser.mobile.android.js.CookieBlock
import com.mega.browser.mobile.android.js.DarkMode
import com.mega.browser.mobile.android.js.InvertPage
import com.mega.browser.mobile.android.js.SetWidenViewport
import com.mega.browser.mobile.android.js.TextReflow
import com.mega.browser.mobile.android.js.ThemeColor
import com.mega.browser.mobile.android.js.Translate
...
class AppModule {
    ...
    fun providesSuggestionsHttpClient(application: Application): Single<OkHttpClient> = Single.fromCallable {
        ...
        return@fromCallable OkHttpClient.Builder()
            .cache(Cache(suggestionsCache, com.mega.browser.mobile.android.utils.FileUtils.megabytesToBytes(1)))
    ...
    fun providesHostsHttpClient(application: Application): Single<OkHttpClient> = Single.fromCallable {
        ...
        return@fromCallable OkHttpClient.Builder()
            .cache(Cache(suggestionsCache, com.mega.browser.mobile.android.utils.FileUtils.megabytesToBytes(5)))
            .addNetworkInterceptor(rewriteCacheControlInterceptor)
            .build()
    }.cache()
