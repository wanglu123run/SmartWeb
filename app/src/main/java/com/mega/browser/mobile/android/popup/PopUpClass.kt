...
package com.mega.browser.mobile.android.popup
...
import com.mega.browser.mobile.android.browser.MenuDividerClass
import com.mega.browser.mobile.android.browser.MenuItemClass
...
import com.mega.browser.mobile.android.extensions.color
...
//                MenuItemClass("add_to_homepage", R.string.action_add_to_homescreen, R.drawable.ic_round_smartphone, true),
        ...
        list?.setOnItemClickListener { parent, listView, position, id ->
            ...
            when((finalMenu[position] as MenuItemClass).id){
                ...
                "share" -> com.mega.browser.mobile.android.utils.IntentUtils(activity)
                    .shareUrl(currentUrl, currentView?.title) // 2 - Share
