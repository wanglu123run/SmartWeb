package com.mega.browser.mobile.android.dialog
...
import com.mega.browser.mobile.android.download.DownloadHandler
import com.mega.browser.mobile.android.extensions.copyToClipboard
...
class LightningDialogBuilder @Inject constructor(
    ...
    fun showLongPressedDialogForBookmarkUrl(
    ...
    ) = BrowserDialog.showWithIcons(activity,
        activity.resources.getString(R.string.action_bookmarks),
        DialogItem(
            title = R.string.dialog_open_new_tab,
            icon = ContextCompat.getDrawable(activity, R.drawable.ic_action_tabs)
        ) {
            uiController.handleNewTab(NewTab.FOREGROUND, entry.url)
        },
        DialogItem(
            title = R.string.dialog_open_background_tab,
            icon = ContextCompat.getDrawable(activity, R.drawable.ic_round_open_in_new)
        ) {
        ...
        DialogItem(
            ...
            icon = ContextCompat.getDrawable(activity, R.drawable.ic_share_black)
        ) {
            com.mega.browser.mobile.android.utils.IntentUtils(activity)
                .shareUrl(entry.url, entry.title)
        },
        DialogItem(
            title = R.string.dialog_copy_link,
            icon = ContextCompat.getDrawable(activity, R.drawable.ic_content_copy_black)
        ) {
            clipboardManager.copyToClipboard(entry.url)
        },
        DialogItem(
            title = R.string.dialog_remove_bookmark,
        ...
        DialogItem(
            title = R.string.dialog_edit_bookmark,
            icon = ContextCompat.getDrawable(activity, R.drawable.ic_action_edit)
        ) {
    ...
    fun showLongPressedHistoryLinkDialog(
        ...
        DialogItem(title = R.string.action_share) {
            com.mega.browser.mobile.android.utils.IntentUtils(activity).shareUrl(url, null)
        },
    ...
    fun showLongPressImageDialog(
        ...
        DialogItem(title = R.string.dialog_download_image) {
            val mimeType = MimeTypeMap.getSingleton().getMimeTypeFromExtension(
                MimeTypeMap.getFileExtensionFromUrl(imageUrl).toLowerCase()
            )
