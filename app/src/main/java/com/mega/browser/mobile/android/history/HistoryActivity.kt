...
package com.mega.browser.mobile.android.history
...
import com.mega.browser.mobile.android.utils.RecyclerItemClickListener
...
class HistoryActivity : AppCompatActivity(), SearchView.OnQueryTextListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (mUserPreferences!!.useTheme === AppTheme.LIGHT) {
            ...
            color = com.mega.browser.mobile.android.utils.ThemeUtils.getColorBackground(this)
