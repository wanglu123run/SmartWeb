...
import com.mega.browser.mobile.android.utils.isHistoryUrl
import com.mega.browser.mobile.android.utils.isSpecialUrl
import com.mega.browser.mobile.android.utils.isStartPageUrl
import com.mega.browser.mobile.android.utils.smartUrlFilter
import com.mega.browser.mobile.android.utils.value
import com.mega.browser.mobile.android.view.BookmarkPageInitializer
...
class TabsManager @Inject constructor(
    ...
    fun saveState() {
        ...
        com.mega.browser.mobile.android.utils.FileUtils.writeBundleToStorage(application, outState, BUNDLE_STORAGE)
     ...
     * browser next starts.
     */
    fun clearSavedState() = com.mega.browser.mobile.android.utils.FileUtils.deleteBundleInStorage(application, BUNDLE_STORAGE)
    ...
    private fun readSavedStateFromDisk(): Observable<Bundle> = Maybe
        .fromCallable { com.mega.browser.mobile.android.utils.FileUtils.readBundleFromStorage(application, BUNDLE_STORAGE) }
